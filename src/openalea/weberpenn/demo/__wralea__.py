   ...
   {  'interface': None,
      ...
      'value': {  'branches': 10,
                  ...
                  'split_angle_variance': 0.0}}],
                             ...
                             elt_factory={  8: ('openalea.weberpenn', 'tree parameters'),
   10: ('openalea.weberpenn', 'weber and penn')},
...
_178249004 = CompositeNodeFactory(name='test_quakingaspen',
   ...
   3: ('system', 'annotation'),
   4: ('openalea.weberpenn', 'weber and penn'),
   5: ('openalea.weberpenn', 'order parameters'),
   6: ('openalea.weberpenn', 'species'),
   7: ('openalea.weberpenn', 'order parameters'),
   8: ('openalea.weberpenn', 'tree parameters'),
   9: ('openalea.weberpenn', 'global parameters'),
   10: ('openalea.weberpenn', 'weber and penn'),
   11: ('openalea.weberpenn', 'order parameters'),
   ...
   17: ('openalea.weberpenn', 'quaking aspen'),
   18: ('openalea.weberpenn', 'tree parameters'),
